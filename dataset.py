...
def wv2pickle(filename='wv.txt', dim=50, outfile='Wv.p'):
    ...
    Wv[0, :] = rng.uniform(low=-0.5, high=0.5, size=(1, dim)) #my unknown embedding
...
if __name__ == "__main__":
    ...
    #     print pb(i)
    #     time.sleep(0.1)
    wv2pickle('/home/yyj/pytorchCNN/BLSTM/dataset/wv_57w.txt', 50,
              '/home/yyj/pytorchCNN/BLSTM/dataset/wv_57w.p')
